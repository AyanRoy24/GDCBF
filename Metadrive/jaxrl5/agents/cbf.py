...
class CBF(Agent):
    ...
    cost_ub: float
    r_min: float 
    mode:int = struct.field(pytree_node=False)  # 1: 'smooth', 2: 'additive', 3: 'maximum'
    ...
    def create(
        ...
        cost_tau: float = 0.2,
        r_min: float = -1.0,
        mode: int = 1,  # 1: 'smooth', 2: 'additive', 3: 'maximum'
